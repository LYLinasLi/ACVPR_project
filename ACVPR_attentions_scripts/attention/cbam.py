...
def ResNet50_CBAM(pretrained=True, progress=True, **kwargs):
    model_path = 'attention/RESNET50_best.pth'
    # resnet50 + cbam
    ...
    model_dict.update(pretrained_dict)  # save the update model_dict
    model.load_state_dict(model_dict)   # load the update model_dict, and update the model init parameters
