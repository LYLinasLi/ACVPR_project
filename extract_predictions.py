    ...
    if not os.path.exists(feats_file):
        ...
        for i, batch in tqdm(enumerate(dl), desc="Extracting features"):
            if torch.cuda.is_available():
                ...
                x = net.forward(batch)
            # feats[i * dl.batch_size:i * dl.batch_size + dl.batch_size] = x.cpu().detach().squeeze(0).reshape(dl.batch_size, -1)
...
if __name__ == "__main__":
    ...
    results_dir = "/home/s2288176/acvpr/results/" + params.dataset + "/" + params.subset + "/"
